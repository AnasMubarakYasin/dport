...
<Page class="bg-neutral text-neutral-content">
	<div transition:fade class="grid place-content-center p-8">
		<Progress bind:this={loader} fixed />
		<section
			class="max-w-lg min-w-[300px] md:min-w-[380px] min-h-[500px] max-h-[600px] p-6 grid gap-6 rounded-xl bg-base-100"
		>
			<div class="grid py-4">
				<h1 class="text-2xl text-center font-bold">Sign In</h1>
				<p class="text-sm text-center text-gray-100/70">Sign In to access your account</p>
			</div>
			{#if state == 'success'}
				<output class="alert alert-success">
					<div class="grid grid-flow-col gap-2">
						<svg
							...
							/></svg
						>
						<div class="text-justify">Sign In Success</div>
					</div>
				</output>
				...
				<div class="grid gap-4 items-start">
					...
					<div class="grid gap-1 text-sm">
						...
						>
							...
							<a href="?" class="text-xs text-gray-100/70 text-right">Forgot password?</a>
						</label>
			...
			<p class="self-end text-xs text-center sm:px-6 dark:text-gray-400">
				...
				<a href="/admin/signup" class="underline dark:text-gray-100">Sign up</a>
			</p>
		</section>
	</div>
</Page>
