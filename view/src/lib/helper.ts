...
export function elementSuppor(element: string, attribute: string) {
...
export async function fetchImageToBlob(url: string, init?: RequestInit) {
...
type TaskHandler<Data, Result> = (data: Data) => Promise<Result>  | Promise<void> | void;
